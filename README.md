...
![TrajectoryShield — a sequence of action tiles inspected together through a translucent pane](docs/assets/cover.png)
...
![TrajectoryShield architecture: action predicates, accumulated effects and optional model evaluation lead to a verdict and explanation](docs/assets/architecture.svg)
...
[Artwork and editable diagrams](docs/assets/README.md). The cover illustrates the research concept; it is not evaluation evidence.
